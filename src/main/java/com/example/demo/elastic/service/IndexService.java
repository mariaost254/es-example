...
import com.example.demo.elastic.helper.Indices;
import com.example.demo.elastic.helper.Util;
...
public class IndexService {
    ...
    public void recreateIndices(final boolean deleteExisting) {
        final String settings = Util.loadAsString("static/settings.json");
    ...
    private String loadMappings(String indexName) {
        final String mappings = Util.loadAsString("static/" + indexName + ".json");
        if (mappings == null) {
