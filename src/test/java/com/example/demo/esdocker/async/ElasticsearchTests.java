...
import com.example.demo.esdocker.Page;
...
public class ElasticsearchTests { //tests product service impl

    private static final ElasticsearchContainer container =
            new ElasticsearchContainer("docker.elastic.co/elasticsearch/elasticsearch:7.10.0").withExposedPorts(9200); //starts docker contaienr

    private static final NodeSelector INGEST_NODE_SELECTOR = nodes -> {
        final Iterator<org.elasticsearch.client.Node> iterator = nodes.iterator();
